...
namespace Key {
	const char kBackspace = 0x08;
	const char kReturn = 0x0d;
	const char kEscape = 0x1b;
	const char kF3 = (char)0x80;
	const char kF4 = (char)0x81;
	const char kF5 = (char)0x82;
	const char kF6 = (char)0x83;
	const char kF1 = (char)0x84;
	const char kF2 = (char)0x85;
	const char kScrollLock = (char)0x86;
}

char AdlEngine_PC::convertEvent(const Common::Event &event) const {
...
void AdlEngine_PC::handleTextOverflow() {
	...
	while (true) {
		...
		if (key == Key::kScrollLock || key == Key::kReturn)
			break;
	}
